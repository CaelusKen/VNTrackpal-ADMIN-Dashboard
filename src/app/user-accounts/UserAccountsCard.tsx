...
const mockUsers: User[] = [
  { id: 1, name: "John Doe", email: "john@example.com", status: "active", subscription: "free" },
  { id: 2, name: "Jane Smith", email: "jane@example.com", status: "active", subscription: "premium" },
...
const UserAccountsCard: React.FC = () => {
  ...
  const { chartData, totalActiveUsers } = useMemo(() => processChartData(dailyData, chartView), [dailyData, chartView])
  ...
  return (
    <main className="w-full p-6">
      <div className="flex flex-col space-y-6">
        ...
        <UserTable users={users} searchTerm={searchTerm} onDisableUser={handleDisableUser} />
        ...
        <div className="text-sm text-gray-500">Total Active Users monthly: {totalActiveUsers}</div>
      </div>
    </main>
  )
}
